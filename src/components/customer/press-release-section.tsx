...
function PressReleaseCard({
    ...
    return (
        <div
            onClick={onClick}
            className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 hover:shadow-lg hover:border-primary-purple/30 transition-all duration-200 cursor-pointer group"
        >
            {/* 제목 */}
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4 line-clamp-2 group-hover:text-primary-purple transition-colors">
                {pressRelease.title}
            </h3>
