            ...
            {!searchQuery.trim() && hasMore && (
                <div className="text-center mt-6 sm:mt-8">
                    <button
                        ...
                        disabled={loading}
                        className="px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base bg-primary-purple text-white rounded-lg hover:bg-primary-purple/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
                        {loading ? "로딩 중..." : "더보기"}
                    </button>
                </div>
...
function ImportantNoticeItem({ notice, onClick, formatDate }: NoticeItemProps) {
    return (
        <div className="py-4 sm:py-6">
            <button
                onClick={onClick}
                className="w-full text-left hover:bg-gray-50/50 focus:outline-none transition-colors py-1 sm:py-2 -mx-1 sm:-mx-2 px-1 sm:px-2 rounded-lg group"
            >
                <div className="flex items-start justify-between">
                    <div className="flex-1 pr-2 sm:pr-4">
                        <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                            <span className="text-xs font-bold text-white bg-primary-purple px-1.5 sm:px-2 py-0.5 sm:py-1 rounded uppercase tracking-wide">
                                중요
                            </span>
                        ...
                        <h3 className="text-sm sm:text-lg font-medium text-background-dark leading-relaxed group-hover:text-primary-purple transition-colors">
                            {notice.title}
                        </h3>
                    </div>
                    <div className="flex-shrink-0 ml-2 sm:ml-4 pt-1">
                        <svg
                            className="h-4 sm:h-5 w-4 sm:w-5 text-gray-400 group-hover:text-primary-purple transition-colors"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
