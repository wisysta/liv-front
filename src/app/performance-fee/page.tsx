    ...
    return (
        <PageLayout headerOverlay={true} fullHeight={false}>
            <PerformanceFeeHero
                ...
                contentBlocks={[
                    {
                        text: "매장에서 음악을 재생하는 행위, 사실은 단순한 '재생'이 아니라 '공연'에 해당\n이를 위해 창작자에게 정당한 보상을 지급하는 것",
                        mobileText:
                            "매장에서 음악을 재생하는 행위,\n사실은 단순한 '재생'이 아니라 '공연'에 해당\n이를 위해 창작자에게 정당한 보상을 지급하는 것",
                        className:
                            "text-lg lg:text-xl 2xl:text-2xl font-semibold",
                    },
                    {
            ...
            <section className="bg-white py-16 sm:py-16 xl:py-20 lg:py-32 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        {/* 텍스트와 버튼 - 모바일에서 맨 위로 */}
                        <div
                            className={`space-y-6 lg:space-y-8 transition-all duration-1500 ease-out order-1 lg:order-1 lg:col-span-1 ${
                                faqSection.isVisible
                                    ? "opacity-100 translate-y-0"
                                    : "opacity-0 translate-y-20"
                            }`}
                        >
                            <h2 className="text-2xl sm:text-3xl lg:text-3xl 2xl:text-4xl font-bold text-background-dark leading-[1.1]">
                                꼭 내야하는 건가요?
                            </h2>
                            <p className="text-sm sm:text-lg lg:text-xl leading-relaxed text-background-dark">
                                네,{" "}
                        ...
                        {/* 오른쪽 이미지 - 우측에서 슬라이드 */}
                        <div
                            className={`aspect-square rounded-lg overflow-hidden transition-all duration-1500 ease-out order-2 lg:order-2 lg:col-span-1 ${
                                faqSection.isVisible
                        ...
                        {/* 관계법령 - 모바일에서만 표시 */}
                        <div
                            className={`space-y-3 transition-all duration-1500 ease-out order-3 lg:hidden ${
                                faqSection.isVisible
                                    ? "opacity-100 translate-y-0"
                                    : "opacity-0 translate-y-20"
                            }`}
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="space-y-4 hidden lg:block">
                                <h3 className="text-xl sm:text-2xl lg:text-2xl font-bold text-background-dark">
                                    통합징수란?
                                </h3>
                                <p className="text-sm sm:text-base lg:text-lg leading-relaxed text-background-dark">
                                    매장에서 음악을 틀기 위해 4개의 음악단체에
                                    공연권료를
                                    <br />
                        ...
                        {/* 통합징수란? - 모바일에서만 표시 */}
                        <div
                            className={`space-y-4 transition-all duration-1500 ease-out order-3 lg:hidden ${
                                mainSection.isVisible
                                    ? "opacity-100 translate-y-0"
                                    : "opacity-0 translate-y-20"
                            }`}
                        ...
                        {/* 관계법령 - 모바일에서만 표시 */}
                        <div
                            className={`space-y-3 transition-all duration-1500 ease-out order-4 lg:hidden ${
                                mainSection.isVisible
                                    ? "opacity-100 translate-y-0"
                                    : "opacity-0 translate-y-20"
                            }`}
